...
Route::group(['namespace' => 'Ext'], function() {
    ...
    Route::post('/jssdk','IndexController@jssdk');
});
...
//    Route::post('/userInfo/store', 'UserInfoController@store');
    ...
    Route::get('/userInfo/checkStore', 'UserInfoController@checkStore');
...
//    ]);
    ...
    Route::get('/moneyAllList','MoneyController@showAllList');
    ...
    //小模块
    Route::post('/detail/audit/{id}', 'DetailController@audit');
    Route::post('/detail/reject/{id}', 'DetailController@reject');
